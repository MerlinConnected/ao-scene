...
export default function App() {
	return (
		<Canvas shadows gl={{ antialias: false }} camera={{ position: [10, 10, 0] }}>
			...
			<directionalLight color='white' intensity={2} angle={0.7} penumbra={5} position={[0, 20, 30]} castShadow shadow-mapSize={1024} shadow-bias={0} />

			<OrbitControls />

			<Center>
				<boxGeometry args={[1, 1, 1]} color={'hotpink'} />
				<Gltf castShadow receiveShadow scale={0.1} src='/docks.glb' inject={<meshStandardMaterial color='white' />} />
			</Center>
